...
class ControlTransferUnit extends Module {
  ...
  .elsewhen(io.controltransferop === 3.U){ //branch instruction
    when((io.funct3 === "b000".U & io.operand1 === io.operand2) | (io.funct3 === "b001".U & io.operand1 =/= io.operand2) 
       | (io.funct3 === "b100".U & io.operand1.asSInt < io.operand2.asSInt) | (io.funct3 === "b101".U & io.operand1.asSInt >= io.operand2.asSInt)
       | (io.funct3 === "b110".U & io.operand1 < io.operand2) | (io.funct3 === "b111".U & io.operand1 >= io.operand2)){
        io.nextpc := io.pc + io.imm
        io.taken := true.B
       }
  }
